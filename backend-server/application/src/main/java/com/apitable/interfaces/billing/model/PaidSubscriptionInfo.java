...
/**
 * Paid Subscription with unlimited seats.
 *
 * @author ShawnDeng
 */
public class PaidSubscriptionInfo implements SubscriptionInfo {

    private final String product;
    private final String basePlan;
    private final SubscriptionFeature feature;

    public PaidSubscriptionInfo() {
        this("PRO", "pro_unlimited", new PaidSubscriptionFeature());
    }
     ...
     */
    public PaidSubscriptionInfo(String product, String basePlan, SubscriptionFeature feature) {
